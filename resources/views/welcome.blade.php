    ...
    <style>
        ...
        @layer theme {
            ...
            :host {
                ...
                --color-pink-600: oklch(.592 .249 0.584);
                --color-pink-700: oklch(.525 .223 3.958deg);
                --color-pink-800: oklch(.459 .187 3.815deg);
                --color-pink-900: oklch(.408 .153 2.432deg);
                --color-pink-950: oklch(.284 .109 3.907deg);
