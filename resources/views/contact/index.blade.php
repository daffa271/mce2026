                ...
                <div class="bg-gradient-to-br from-emerald-600 to-teal-600 text-white p-8 rounded-2xl shadow-xl">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-sm text-emerald-100">Email</p>
                                <p class="font-medium">info@magetancampusexpo.id</p>
                            </div>
                        </li>
                        ...
                        <div class="flex gap-3">
                            <a href="#" class="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition">
                                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12S0 5.446 0 12.073c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953h-1.513c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="#" class="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition">
                                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919zM12 0C8.74 0 8.332.014 7.052.072 2.694.272.272 2.694.072 7.052.014 8.332 0 8.74 0 12c0 3.26.014 3.668.072 4.948.2 4.358 2.622 6.78 6.98 6.98 1.28.058 1.688.072 4.948.072 3.26 0 3.668-.014 4.948-.072 4.358-.2 6.78-2.622 6.98-6.98.058-1.28.072-1.688.072-4.948 0-3.26-.014-3.668-.072-4.948C23.728 2.694 21.306.272 16.948.072 15.668.014 15.26 0 12 0z"/>
                                </svg>
                            </a>
                        </div>
                    </div>
